...
clean_display:
    ...
    MOV BH, 00110001b        ; Atributos de color
...
read_and_display:
    ...
    MOV DH, 0Bh              ; Fila inicial para mostrar los caracteres
    MOV DL, 1Eh              ; Columna inicial para mostrar los caracteres
...
read_next_char:
    ...
    MOV BL, 00110001b              ; Atributos de color
